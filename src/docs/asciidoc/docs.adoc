...
=== 4.8. 팀 소개서 - 팀원 소개 리스트 생성/수정
include::{snippets}/team-member-introduction-controller-test/create-team-member-introductions/http-request.adoc[]
include::{snippets}/team-member-introduction-controller-test/create-team-member-introductions/request-fields.adoc[]
...
=== 4.9. 팀 소개서 - 팀 연혁 리스트 생성/수정
include::{snippets}/history-controller-test/create-histories/http-request.adoc[]
include::{snippets}/history-controller-test/create-histories/request-fields.adoc[]
=== 4.9. 팀 소개서 - 팀 연혁 삭제
