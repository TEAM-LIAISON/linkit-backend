...
==== 응답
include::{snippets}/search-controller-test/get-team-announcement-and-team-mini-profile/http-response.adoc[]
include::{snippets}/search-controller-test/get-team-announcement-and-team-mini-profile/response-fields.adoc[]
