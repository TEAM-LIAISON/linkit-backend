...
=== 내 이력서 - 보유기술 생성 (온보딩 API 동일)
=== [POST /profile_skill]

=== 내 이력서 - 희망 팀빌딩 분야 생성 (온보딩 API 동일)
=== [POST /profile_team_building_field]

=== 내 이력서 - 활동 지역 및 위치 생성 (온보딩 API 동일)
=== [POST /profile_region]

=== 내 이력서 - 이력 생성 (온보딩 API 동일)
=== [POST /antecedents]

=== 내 이력서 - 학력 생성 (온보딩 API 동일)
=== [POST /education]
...
=== [POST /attach/file]
==== 요청
include::{snippets}/attach-controller-test/create-attach-file/http-request.adoc[]
include::{snippets}/attach-controller-test/create-attach-file/request-parts.adoc[]

== 4. 팀 소개서
=== 팀 소개서 - 팀 희망 팀빌딩 분야 생성
...
=== 팀 소개서 - 활동 방식, 활동 지역 및 위치 생성 (온보딩 API 동일)
=== [POST /activity-method]
