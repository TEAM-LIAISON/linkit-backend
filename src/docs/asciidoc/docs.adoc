...
==== 요청
include::{snippets}/on-boarding-controller-test/get-on-boarding-profile/http-request.adoc[]
==== 응답
include::{snippets}/on-boarding-controller-test/get-on-boarding-profile/http-response.adoc[]
include::{snippets}/on-boarding-controller-test/get-on-boarding-profile/response-fields.adoc[]

=== 1.5.2. 내 이력서 희망 팀빌딩 분야 생성/수정
==== 요청
include::{snippets}/on-boarding-controller-test/create-profile-team-building-field/http-request.adoc[]
include::{snippets}/on-boarding-controller-test/create-profile-team-building-field/request-fields.adoc[]
...
==== 요청
include::{snippets}/on-boarding-controller-test/create-on-boarding-personal-job-and-skill/http-request.adoc[]
include::{snippets}/on-boarding-controller-test/create-on-boarding-personal-job-and-skill/request-fields.adoc[]
