...
public class NotificationHandler {
     ...
     * 수신자 매칭 요청 알림 생성
     */
    public NotificationDetails generateRequestedStateReceiverNotificationDetails(final Matching matching) {
     ...
     * 수신자 매칭 성사 알림 생성
     */
    public NotificationDetails generateAcceptedStateReceiverNotificationDetails(final Matching matching) {
        if (matching.getReceiverType().equals(ReceiverType.ANNOUNCEMENT)) {
     ...
     * 발신자 매칭 성사 알림 생성
     */
    public NotificationDetails generateAcceptedStateSenderNotificationDetails(final Matching matching) {
        if (matching.getReceiverType().equals(ReceiverType.ANNOUNCEMENT)) {
            return NotificationDetails.announcementAccepted(
                matching.getId(),
     ...
     * 발신자 매칭 거절 알림 생성
     */
    public NotificationDetails generatedRejectedStateSenderNotificationDetails(final Matching matching) {
        if (matching.getReceiverType().equals(ReceiverType.ANNOUNCEMENT)) {
     ...
     * 수신자에게 매칭 요청 알림 발송
     */
    public void alertNewRequestedNotificationToReceiver(final Matching matching, final NotificationDetails notificationDetails) {
        if (matching.getReceiverType().equals(ReceiverType.ANNOUNCEMENT)) {
     ...
     * 수신자에게 매칭 성사 알림 발송
     */
    public void alertNewAcceptedNotificationToReceiver(final Matching matching, final NotificationDetails notificationDetails) {
        if (matching.getReceiverType().equals(ReceiverType.ANNOUNCEMENT)) {
            notificationService.alertNewNotification(
                notificationMapper.toNotification(
                    matchingInfoResolver.getReceiverMemberId(matching),
     ...
     * 발신자에게 매칭 성사 알림 발송
     */
    public void alertNewAcceptedNotificationToSender(final Matching matching, final NotificationDetails notificationDetails) {
        if (matching.getReceiverType().equals(ReceiverType.ANNOUNCEMENT)) {
            notificationService.alertNewNotification(
                notificationMapper.toNotification(
     ...
     * 발신자에게 매칭 거절 알림 발송
     */
    public void alertNewRejectedNotificationToSender(final Matching matching, final NotificationDetails notificationDetails) {
        if (matching.getReceiverType().equals(ReceiverType.ANNOUNCEMENT)) {
            notificationService.alertNewNotification(
                notificationMapper.toNotification(
                    matchingInfoResolver.getSenderMemberId(matching),
