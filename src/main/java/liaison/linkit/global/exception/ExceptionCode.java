...
public enum ExceptionCode {
    ...
    NOT_FOUND_REFRESH_TOKEN(9106, "refreshToken에 해당하는 쿠키 정보가 없습니다."),
    ...
    HAVE_TO_INPUT_JOB_ROLE_NAME(10007, "팀원 공고의 직무/역할을 입력해주세요"),
    ...
    NOT_ALLOW_BROWSE(10018, "프로필 열람 조건을 충족하지 못하였습니다."),
