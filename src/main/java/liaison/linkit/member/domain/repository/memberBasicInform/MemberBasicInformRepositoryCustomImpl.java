...
public class MemberBasicInformRepositoryCustomImpl implements MemberBasicInformRepositoryCustom {
    ...
    public Optional<MemberBasicInform> updateMemberBasicInform(
        ...
        long affectedRows =
                jpaQueryFactory
                        .update(qMemberBasicInform)
                        .set(
                                qMemberBasicInform.memberName,
                                updateMemberBasicInformRequest.getMemberName())
                        .set(
                                qMemberBasicInform.contact,
                                updateMemberBasicInformRequest.getContact())
                        .where(qMemberBasicInform.member.id.eq(memberId))
                        .execute();

        if (affectedRows > 0) {
            // 업데이트된 객체를 다시 조회해서 반환
            MemberBasicInform updatedEntity =
                    jpaQueryFactory
    ...
    public Optional<MemberBasicInform> updateConsentServiceUse(
        ...
        long affectedRows =
                jpaQueryFactory
                        .update(qMemberBasicInform)
                        .set(
                                qMemberBasicInform.serviceUseAgree,
                                updateConsentServiceUseRequest.getIsServiceUseAgree())
                        .set(
                                qMemberBasicInform.privateInformAgree,
                                updateConsentServiceUseRequest.getIsPrivateInformAgree())
                        .set(
                                qMemberBasicInform.ageCheck,
                                updateConsentServiceUseRequest.getIsAgeCheck())
                        .set(
                                qMemberBasicInform.marketingAgree,
                                updateConsentServiceUseRequest.getIsMarketingAgree())
                        .where(qMemberBasicInform.member.id.eq(memberId))
                        .execute();
    ...
    public Optional<MemberBasicInform> updateConsentMarketing(
        ...
        long affectedRows =
                jpaQueryFactory
                        ...
                        .set(
                                qMemberBasicInform.marketingAgree,
                                updateConsentMarketingRequest.getIsMarketingAgree())
                        .where(qMemberBasicInform.member.id.eq(memberId))
                        .execute();
