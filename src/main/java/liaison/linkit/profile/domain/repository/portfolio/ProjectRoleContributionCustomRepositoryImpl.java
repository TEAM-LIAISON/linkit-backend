...
@Slf4j
public class ProjectRoleContributionCustomRepositoryImpl
        implements ProjectRoleContributionCustomRepository {
    ...
    public Map<Long, List<String>> getProjectRolesByProfileId(final Long profileId) {
        ...
        List<Tuple> results =
                jpaQueryFactory
                        ...
                        .leftJoin(
                                qProfilePortfolio.projectRoleContributions,
                                qProjectRoleContribution)
