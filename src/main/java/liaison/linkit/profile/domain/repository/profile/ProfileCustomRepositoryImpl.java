                ...
                jpaQueryFactory
                        ...
                        .where(
                                qProfile.status
                                        ...
                                        .and(
                                                qProfile.id.in(
                                                        171L, 160L, 168L, 154L, 167L, 108L, 58L,
                                                        57L)))
                        .orderBy(
                                new CaseBuilder()
                                        .when(qProfile.id.eq(171L))
                                        .then(0)
                                        .when(qProfile.id.eq(160L))
                                        .then(1)
                                        .when(qProfile.id.eq(168L))
                                        .then(2)
                                        .when(qProfile.id.eq(154L))
                                        .then(3)
                                        .when(qProfile.id.eq(167L))
                                        .then(4)
                                        .when(qProfile.id.eq(108L))
                                        .then(5)
