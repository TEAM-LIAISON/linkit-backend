...
public enum ProfileLogErrorCode implements BaseErrorCode {
    UPDATE_PROFILE_LOG_TYPE_BAD_REQUEST(BAD_REQUEST, "PROFILE_LOG_400_1", "비공개된 로그는 대표 로그로 변경할 수 없습니다."),
    UPDATE_PROFILE_LOG_PUBLIC_BAD_REQUEST(BAD_REQUEST, "PROFILE_LOG_400_2", "대표 로그는 비공개 로그로 변경할 수 없습니다."),
