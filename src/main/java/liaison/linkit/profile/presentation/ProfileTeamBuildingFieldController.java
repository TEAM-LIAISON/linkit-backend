...
import liaison.linkit.profile.service.ProfileTeamBuildingService;
...
public class ProfileTeamBuildingFieldController {
    ...
    private final ProfileTeamBuildingService profileTeamBuildingService;

    // 희망 팀빌딩 항목 전체 조회
    @GetMapping
    @MemberOnly
    public ResponseEntity<List<ProfileTeamBuildingResponse>> getProfileTeamBuildingList(@Auth final Accessor accessor) {
        final List<ProfileTeamBuildingResponse> profileTeamBuildingResponses = profileTeamBuildingService.getAllProfileTeamBuildings(accessor.getMemberId());
    ...
    public ResponseEntity<ProfileTeamBuildingResponse> createProfileTeamBuilding(
        ...
        final ProfileTeamBuildingResponse profileTeamBuildingResponse = profileTeamBuildingService.save(accessor.getMemberId(), profileTeamBuildingCreateRequest);
