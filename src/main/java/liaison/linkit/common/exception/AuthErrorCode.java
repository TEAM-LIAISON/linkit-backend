...
public enum AuthErrorCode implements BaseErrorCode {
    ...
    ACCESS_TOKEN_EXPIRED(450, "AUTH_450_1", "AccessToken 인증 시간이 만료되었습니다. 인증토큰을 재발급 해주세요"),
    INVALID_ACCESS_TOKEN(450, "AUTH_450_2", "유효하지 않은 AccessToken입니다. 인증토큰을 재발급 해주세요"),
    ...
    ACCESS_TOKEN_NOT_EXIST(450, "AUTH_450_2", "올바른 AccessToken을 넣어주세요."),
