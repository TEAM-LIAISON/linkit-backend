                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                <td style="padding: 30px 20px; text-align: center;">
                                                  <h1 style="font-family: Pretendard, 'Apple SD Gothic Neo', 'Noto Sans KR', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; font-size: 20px; font-weight: 600; margin: 0 0 16px 0; word-break: keep-all;"><span style="color: #2563EB;">리에종</span> <span style="color: #27364B;">새로운 모집 공고</span></h1>
                                                              ...
                                                              <table border="0" cellpadding="0" cellspacing="0" width="100%%">
                                                                <tr>
                                                                  ...
                                                                  <td style="vertical-align: middle;">
                                                                    <p style="font-family: Pretendard, 'Apple SD Gothic Neo', 'Noto Sans KR', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; font-size: 16px; font-weight: 600; margin: 0; color: #27364B;">팀이름</p>
                                                                  </td>
                                                                </tr>
                                                              </table>

                                                              <p style="font-family: Pretendard, 'Apple SD Gothic Neo', 'Noto Sans KR', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; font-size: 16px; font-weight: 600; color: #27364B; margin: 16px 0 0 0;">외주 프로젝트를 위해 개발자를 찾고 있습니다</p>
                                                             \s
                                                              <div style="margin-top: 16px;">
                                                                <span style="display: inline-block; padding: 6px 12px; background-color: #D3E1FE; border-radius: 6px; margin-right: 8px; font-family: Pretendard, 'Apple SD Gothic Neo', 'Noto Sans KR', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; font-size: 12px; color: #2563EB;">포지션 대분류</span> \s
                                                                <span style="display: inline-block; padding: 6px 12px; background-color: #EDF3FF; border-radius: 6px; margin-right: 8px; font-family: Pretendard, 'Apple SD Gothic Neo', 'Noto Sans KR', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; font-size: 12px; color: #2563EB;">요구 스킬</span>
                                                                <!-- %MORE_TAG_START% -->
                                                                <span style="display: inline-block; padding: 6px 12px; background-color: #EDF3FF; border-radius: 6px; font-family: Pretendard, 'Apple SD Gothic Neo', 'Noto Sans KR', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; font-size: 12px; color: #2563EB;">+%s</span>
                                                                <!-- %MORE_TAG_END% -->
                                                              </div>
                                                            </td>
                                                          </tr>
