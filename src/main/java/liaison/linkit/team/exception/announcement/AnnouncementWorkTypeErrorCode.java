...
@Getter
@AllArgsConstructor
public enum AnnouncementWorkTypeErrorCode implements BaseErrorCode {
    ANNOUNCEMENT_WORK_TYPE_NOT_FOUND(
            NOT_FOUND, "ANNOUNCEMENT_WORK_TPYE_404_1", "해당하는 팀원 공고의 업무 형태를 찾을 수 없습니다.");
