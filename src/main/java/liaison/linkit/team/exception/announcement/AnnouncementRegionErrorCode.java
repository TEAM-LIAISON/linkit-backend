...
@Getter
@AllArgsConstructor
public enum AnnouncementRegionErrorCode implements BaseErrorCode {
    ANNOUNCEMENT_REGION_NOT_FOUND(NOT_FOUND, "ANNOUNCEMENT_REGION_404_1", "해당하는 팀원 공고의 활동 지역을 찾을 수 없습니다.");
