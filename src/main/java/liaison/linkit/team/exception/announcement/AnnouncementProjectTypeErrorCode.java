...
@Getter
@AllArgsConstructor
public enum AnnouncementProjectTypeErrorCode implements BaseErrorCode {
    ANNOUNCEMENT_PROJECT_TYPE_NOT_FOUND(
            NOT_FOUND, "ANNOUNCEMENT_PROJECT_TPYE_404_1", "해당하는 팀원 공고의 프로젝트 유형을 찾을 수 없습니다.");
