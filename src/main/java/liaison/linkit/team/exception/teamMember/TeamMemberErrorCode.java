...
public enum TeamMemberErrorCode implements BaseErrorCode {
    OWNER_TEAM_MEMBER_OUT_BAD_REQUEST(410, "TEAM_MEMBER_400_1", "대표는 팀 나가기를 요청할 수 없습니다,"),
    MANAGING_BAD_REQUEST(BAD_REQUEST, "TEAM_MEMBER_400_2", "팀 삭제 수락/거절 권한이 없습니다."),
    REMOVE_TEAM_MEMBER_BAD_REQUEST(
            BAD_REQUEST, "TEAM_MEMBER_400_3", "팀 삭제 권한이 없는 회원의 팀원 삭제 요청입니다."),
