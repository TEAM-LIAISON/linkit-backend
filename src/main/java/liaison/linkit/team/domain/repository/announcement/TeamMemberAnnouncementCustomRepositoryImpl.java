        ...
        List<TeamMemberAnnouncement> content = jpaQueryFactory
            ...
            .orderBy(
                new CaseBuilder()
                    ...
                    .when(qTeamMemberAnnouncement.id.eq(35L)).then(1)
                    .when(qTeamMemberAnnouncement.id.eq(27L)).then(2)
                    .when(qTeamMemberAnnouncement.id.eq(37L)).then(3)
                    .when(qTeamMemberAnnouncement.id.eq(4L)).then(4)
                    .when(qTeamMemberAnnouncement.id.eq(50L)).then(5)
                    .when(qTeamMemberAnnouncement.id.eq(46L)).then(6)
        ...
        return jpaQueryFactory
            ...
            .orderBy(
                ...
                new CaseBuilder()
                    ...
                    .when(qTeamMemberAnnouncement.id.eq(6L)).then(1)
                    .when(qTeamMemberAnnouncement.id.eq(27L)).then(2)
                    .when(qTeamMemberAnnouncement.id.eq(26L)).then(3)
                    .when(qTeamMemberAnnouncement.id.eq(46L)).then(4)
                    .when(qTeamMemberAnnouncement.id.eq(4L)).then(5)
                    .when(qTeamMemberAnnouncement.id.eq(10L)).then(6)
                    .when(qTeamMemberAnnouncement.id.eq(8L)).then(7)
                    .when(qTeamMemberAnnouncement.id.eq(22L)).then(8)
                    .otherwise(9)
                    .asc()
            )
            .limit(limit)
