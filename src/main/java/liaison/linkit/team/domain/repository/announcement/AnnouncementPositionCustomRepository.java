...
public interface AnnouncementPositionCustomRepository {
    boolean existsAnnouncementPositionByTeamMemberAnnouncementId(final Long teamMemberAnnouncementId);

    Optional<AnnouncementPosition> findAnnouncementPositionByTeamMemberAnnouncementId(final Long teamMemberAnnouncementId);
