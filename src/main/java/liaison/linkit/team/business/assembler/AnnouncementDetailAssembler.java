...
public class AnnouncementDetailAssembler {
     ...
     */
    public TeamMemberAnnouncementDetail assemblerTeamMemberAnnouncementDetail(final Optional<Long> optionalMemberId, final String teamCode, final Long teamMemberAnnouncementId) {
        // 1. 조회할 팀 정보
