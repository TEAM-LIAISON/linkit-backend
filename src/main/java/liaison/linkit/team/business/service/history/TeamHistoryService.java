...
public class TeamHistoryService {
    ...
    @Transactional(readOnly = true)
    public TeamHistoryResponseDTO.TeamHistoryItems getTeamHistoryItems(
    ...
    @Transactional(readOnly = true)
    public TeamHistoryResponseDTO.TeamHistoryDetail getTeamHistoryDetail(
    ...
    public TeamHistoryResponseDTO.AddTeamHistoryResponse addTeamHistory(
            final Long memberId,
    ...
    public TeamHistoryResponseDTO.UpdateTeamHistoryResponse updateTeamHistory(
        ...
        final TeamHistory updatedTeamHistory =
                teamHistoryCommandAdapter.updateTeamHistory(
                        teamHistoryId, updateTeamHistoryRequest);
        return teamHistoryMapper.toUpdateTeamHistoryResponse(updatedTeamHistory);
    }

    public TeamHistoryResponseDTO.RemoveTeamHistoryResponse removeTeamHistory(
            final Long memberId, final String teamCode, final Long teamHistoryId) {
