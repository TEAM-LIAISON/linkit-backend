...
public class AnnouncementSkillMapper {
    ...
    public List<AnnouncementSkill> toAddProjectSkills(
            final TeamMemberAnnouncement teamMemberAnnouncement, final List<Skill> skills) {
        return skills.stream()
                .map(
                        skill ->
                                AnnouncementSkill.builder()
                                        .id(null)
    ...
    public List<TeamMemberAnnouncementResponseDTO.AnnouncementSkillName> toAnnouncementSkillNames(
