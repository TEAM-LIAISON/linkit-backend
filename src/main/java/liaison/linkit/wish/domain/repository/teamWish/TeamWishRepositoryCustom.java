...
public interface TeamWishRepositoryCustom {
    ...
    Optional<TeamWish> findByMemberIdAndTeamMemberAnnouncementId(
            final Long memberId,
            final Long teamMemberAnnouncementId
    );

    boolean existsByTeamMemberAnnouncementIdAndMemberId(final Long teamMemberAnnouncementId, final Long memberId);
