...
public class TeamProductControllerTest extends ControllerTest {
    ...
    @MockBean private TeamProductService teamProductService;
    ...
    private ResultActions performGetTeamProductViewItems(final String teamCode) throws Exception {
        return mockMvc.perform(
                RestDocumentationRequestBuilders.get(
                        "/api/v1/team/{teamCode}/product/view", teamCode));
    }
    ...
    private ResultActions performGetTeamProductDetail(
            final String teamCode, final Long teamProductId) throws Exception {
        return mockMvc.perform(
                RestDocumentationRequestBuilders.get(
                                "/api/v1/team/{teamCode}/product/{teamProductId}",
                                teamCode,
                                teamProductId)
                        .header(AUTHORIZATION, MEMBER_TOKENS.getAccessToken())
                        .cookie(COOKIE));
    ...
    private ResultActions performRemoveTeamProduct(final String teamCode, final Long teamProductId)
            throws Exception {
        return mockMvc.perform(
                        ...
                        .andDo(
                                restDocs.document(
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].teamProductId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("팀 프로덕트 ID"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].productName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 이름"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].productLineDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 한 줄 소개"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].productField")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 분야"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].productStartDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 시작 날짜"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].productEndDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 종료 날짜"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].productRepresentImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 대표 이미지 경로"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].isProductInProgress")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로덕트 진행 중 여부"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].teamProductLinks")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로덕트 링크 목록"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].teamProductLinks[].productLinkId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("프로덕트 링크 ID"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].teamProductLinks[].productLinkName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 링크 이름"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].teamProductLinks[].productLinkPath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 링크 경로"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].productDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 설명"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].teamProductImages")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("프로덕트 이미지 정보 객체"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].teamProductImages.productRepresentImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 대표 이미지 경로"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].teamProductImages.productSubImages")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로덕트 보조 이미지 리스트"),
                                                fieldWithPath(
                                                                "result.teamProductViewItems[].teamProductImages.productSubImages[].productSubImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 보조 이미지 경로"))))
                        .andReturn();

        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<TeamProductResponseDTO.TeamProductViewItems> actual =
                objectMapper.readValue(
                        jsonResponse, new TypeReference<CommonResponse<TeamProductViewItems>>() {});

        final CommonResponse<TeamProductViewItems> expected =
                CommonResponse.onSuccess(teamProductViewItems);
    ...
    void getTeamProductItems() throws Exception {
        // given
        final TeamProductResponseDTO.TeamProductItem firstTeamProductItem =
                TeamProductResponseDTO.TeamProductItem.builder()
                        .teamProductId(1L)
                        .productName("프로덕트 제목 1")
                        .productLineDescription("프로덕트 한 줄 소개 1")
                        .productField("프로덕트 분야 1")
        ...
        final TeamProductResponseDTO.TeamProductItem secondTeamProductItem =
                TeamProductResponseDTO.TeamProductItem.builder()
                        .teamProductId(1L)
                        .productName("프로덕트 제목 2")
                        .productLineDescription("프로덕트 한 줄 소개 2")
                        ...
                        .andDo(
                                restDocs.document(
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.teamProductItems[].teamProductId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("팀 프로덕트 ID"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].productName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 이름"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].productLineDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 한 줄 소개"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].productField")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 분야"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].productStartDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 시작 날짜"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].productEndDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 종료 날짜"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].productRepresentImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 대표 이미지 경로"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].isProductInProgress")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로덕트 진행 중 여부"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].teamProductLinks")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로덕트 링크 목록"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].teamProductLinks[].productLinkId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("프로덕트 링크 ID"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].teamProductLinks[].productLinkName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 링크 이름"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].teamProductLinks[].productLinkPath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 링크 경로"),
                                                fieldWithPath(
                                                                "result.teamProductItems[].productDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 설명"))))
                        .andReturn();

        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<TeamProductResponseDTO.TeamProductItems> actual =
                objectMapper.readValue(
                        jsonResponse, new TypeReference<CommonResponse<TeamProductItems>>() {});

        final CommonResponse<TeamProductItems> expected =
                CommonResponse.onSuccess(teamProductItems);
    ...
    void getTeamProductDetail() throws Exception {
        final TeamProductResponseDTO.TeamProductDetail teamProductDetail =
                TeamProductResponseDTO.TeamProductDetail.builder()
                        .teamProductId(1L)
                        .productName("프로덕트 제목 1")
                        .productLineDescription("프로덕트 한 줄 소개 1")
                        ...
                        .build();
        // when
        when(teamProductService.getTeamProductDetail(anyLong(), any(), anyLong()))
                .thenReturn(teamProductDetail);
                                ...
                                restDocs.document(
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath("result.teamProductLinks")
                                                        ...
                                                        .description("프로덕트 링크 목록"),
                                                fieldWithPath(
                                                                "result.teamProductLinks[].productLinkId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("프로덕트 링크 ID"),
                                                fieldWithPath(
                                                                "result.teamProductLinks[].productLinkName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 링크 이름"),
                                                fieldWithPath(
                                                                "result.teamProductLinks[].productLinkPath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 링크 경로"),
                                                ...
                                                fieldWithPath(
                                                                "result.teamProductImages.productRepresentImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 대표 이미지 경로"),
                                                fieldWithPath(
                                                                "result.teamProductImages.productSubImages")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로덕트 보조 이미지 목록"),
                                                fieldWithPath(
                                                                "result.teamProductImages.productSubImages[].productSubImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 보조 이미지 경로"))))
                        .andReturn();

        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<TeamProductDetail> actual =
                objectMapper.readValue(
                        jsonResponse, new TypeReference<CommonResponse<TeamProductDetail>>() {});

        final CommonResponse<TeamProductDetail> expected =
                CommonResponse.onSuccess(teamProductDetail);
    ...
    void addTeamProduct() throws Exception {
        ...
        final MockMultipartFile createRequest =
                new MockMultipartFile(
                        ...
                        "application/json",
                        objectMapper
                                .writeValueAsString(addTeamProductRequest)
                                .getBytes(StandardCharsets.UTF_8));

        // productRepresentImage 생성
        final MockMultipartFile productRepresentImage =
                new MockMultipartFile(
        ...
        // 응답
        final TeamProductResponseDTO.AddTeamProductResponse addTeamProductResponse =
                AddTeamProductResponse.builder()
                        .teamProductId(1L)
                        .productName("프로덕트 이름")
                        .productLineDescription("프로덕트 한 줄 소개")
                        .productField("프로덕트 분야")
        ...
        // when
        when(teamProductService.addTeamProduct(anyLong(), any(), any(), any(), any()))
                .thenReturn(addTeamProductResponse);

        final ResultActions resultActions =
                mockMvc.perform(
                        RestDocumentationRequestBuilders.multipart(
                                        "/api/v1/team/{teamCode}/product", teamCode)
                                ...
                                restDocs.document(
                                        ...
                                        requestPartFields(
                                                ...
                                                fieldWithPath("productName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 이름"),
                                                fieldWithPath("productLineDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 한 줄 소개"),
                                                fieldWithPath("productField")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 분야"),
                                                fieldWithPath("productStartDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 시작 날짜"),
                                                fieldWithPath("productEndDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 종료 날짜"),
                                                fieldWithPath("isProductInProgress")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로덕트 진행 중 여부"),
                                                fieldWithPath("teamProductLinks")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로덕트 링크 목록"),
                                                fieldWithPath("teamProductLinks[].productLinkName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 링크 이름"),
                                                fieldWithPath("teamProductLinks[].productLinkPath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 링크 경로"),
                                                fieldWithPath("productDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 설명")),
                                        responseFields(
                                                fieldWithPath("isSuccess")
        ...
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<AddTeamProductResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<AddTeamProductResponse>>() {});

        final CommonResponse<AddTeamProductResponse> expected =
                CommonResponse.onSuccess(addTeamProductResponse);
    ...
    void updateTeamProduct() throws Exception {
        ...
        final TeamProductRequestDTO.UpdateTeamProductRequest updateTeamProductRequest =
                UpdateTeamProductRequest.builder()
                        .productName("프로덕트 이름")
                        .productLineDescription("프로덕트 한 줄 소개")
                        .productField("프로덕트 분야")
                        .productStartDate("2012.12")
                        ...
                        .teamProductImages(
                                TeamProductRequestDTO.TeamProductImages.builder()
                                        ...
                                        .productSubImages(
                                                Arrays.asList(
                                                        TeamProductRequestDTO.ProductSubImage
                                                                .builder()
                                                                .productSubImagePath(
                                                                        "유지되는 프로덕트 보조 이미지 경로 1")
                                                                .build(),
                                                        TeamProductRequestDTO.ProductSubImage
                                                                .builder()
                                                                .productSubImagePath(
                                                                        "유지되는 프로덕트 보조 이미지 경로 2")
                                                                .build()))
                                        .build())
                        .build();
        ...
        final MockMultipartFile updateRequest =
                new MockMultipartFile(
                        ...
                        "application/json",
                        objectMapper
                                .writeValueAsString(updateTeamProductRequest)
                                .getBytes(StandardCharsets.UTF_8));
        ...
        // 응답
        final TeamProductResponseDTO.UpdateTeamProductResponse updateTeamProductResponse =
                UpdateTeamProductResponse.builder()
                        .teamProductId(1L)
                        .productName("프로덕트 이름")
                        .productLineDescription("프로덕트 한 줄 소개")
                        .productField("프로덕트 분야")
        ...
        // when
        when(teamProductService.updateTeamProduct(anyLong(), any(), anyLong(), any(), any(), any()))
                .thenReturn(updateTeamProductResponse);
                        ...
                        .andDo(
                                restDocs.document(
                                        ...
                                        requestPartFields(
                                                ...
                                                fieldWithPath("productStartDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 시작 날짜 (YYYY.MM)"),
                                                fieldWithPath("productEndDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로덕트 종료 날짜 (YYYY.MM)"),
                                                fieldWithPath("isProductInProgress")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로덕트 진행 중 여부"),
                                                fieldWithPath("teamProductLinks")
                                                ...
                                                fieldWithPath("teamProductImages")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("프로덕트 이미지 정보"),
                                                fieldWithPath(
                                                                "teamProductImages.productRepresentImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("유지되는 대표 이미지 경로"),
                                                fieldWithPath("teamProductImages.productSubImages")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("유지되는 보조 이미지 목록"),
                                                fieldWithPath(
                                                                "teamProductImages.productSubImages[].productSubImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("유지되는 보조 이미지 경로")),
                                        responseFields(
                                                fieldWithPath("isSuccess")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("요청 성공 여부")
        ...
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<UpdateTeamProductResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<UpdateTeamProductResponse>>() {});

        final CommonResponse<UpdateTeamProductResponse> expected =
                CommonResponse.onSuccess(updateTeamProductResponse);
    ...
    void removeTeamProduct() throws Exception {
        ...
        final TeamProductResponseDTO.RemoveTeamProductResponse removeTeamProductResponse =
                RemoveTeamProductResponse.builder().teamProductId(1L).build();

        // when
        when(teamProductService.removeTeamProduct(any(), anyLong()))
                .thenReturn(removeTeamProductResponse);
        ...
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<RemoveTeamProductResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<RemoveTeamProductResponse>>() {});

        final CommonResponse<RemoveTeamProductResponse> expected =
                CommonResponse.onSuccess(removeTeamProductResponse);
