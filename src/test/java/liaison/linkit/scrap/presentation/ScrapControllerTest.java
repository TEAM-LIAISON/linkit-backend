...
//import liaison.linkit.scrap.presentation.dto.response.WishTeamProfileResponse;
...
//
//        // then
//        verify(scrapService).createScrapToPrivateProfile(eq(1L), eq(1L));
//
...
//
//        // then
//        verify(scrapService).cancelScrapToPrivateProfile(eq(1L), eq(1L));
//
...
//
//        // then
//        verify(scrapService).cancelScrapToTeamProfile(eq(1L), eq(1L));
//
//        resultActions.andExpect(status().isNoContent())
//                .andDo(restDocs.document(
//                        pathParameters(
