...
//    }
//
//    private ResultActions performGetBrowseProfileRequest(final int miniProfileId) throws Exception {
//        return mockMvc.perform(get("/browse/private/profile/{miniProfileId}", miniProfileId)
...
//        System.out.println("profileIsValueResponse = " + profileIsValueResponse);
//
//        // 1. 미니 프로필
