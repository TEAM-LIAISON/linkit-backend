...
public class ProfileActivityControllerTest extends ControllerTest {
    ...
    @MockBean private ProfileActivityService profileActivityService;
    ...
    private ResultActions performGetProfileActivityDetail(final Long profileActivityId)
            throws Exception {
        return mockMvc.perform(
                RestDocumentationRequestBuilders.get(
                                "/api/v1/profile/activity/{profileActivityId}", profileActivityId)
                        .header(AUTHORIZATION, MEMBER_TOKENS.getAccessToken())
                        .cookie(COOKIE));
    }

    private ResultActions performAddProfileActivity(final AddProfileActivityRequest request)
            throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performUpdateProfileActivity(
            final Long profileActivityId, final UpdateProfileActivityRequest request)
            throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performRemoveProfileActivity(final Long profileActivityId)
            throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performRemoveActivityCertification(final Long profileActivityId)
            throws Exception {
        return mockMvc.perform(
                delete(
                                "/api/v1/profile/activity/certification/{profileActivityId}",
                                profileActivityId)
                        .header(AUTHORIZATION, MEMBER_TOKENS.getAccessToken())
                        .cookie(COOKIE));
    }
    ...
    void getProfileActivityItems() throws Exception {
        ...
        final ProfileActivityResponseDTO.ProfileActivityItems profileActivityItems =
                new ProfileActivityItems(
                        Arrays.asList(firstProfileActivityItem, secondProfileActivityItem));

        // when
        when(profileActivityService.getProfileActivityItems(anyLong()))
                .thenReturn(profileActivityItems);
                        ...
                        .andDo(
                                restDocs.document(
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.profileActivityItems[].profileActivityId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("내 이력 ID"),
                                                fieldWithPath(
                                                                "result.profileActivityItems[].activityName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("이력 활동명"),
                                                fieldWithPath(
                                                                "result.profileActivityItems[].activityRole")
                                                        .type(JsonFieldType.STRING)
                                                        .description("이력 역할"),
                                                fieldWithPath(
                                                                "result.profileActivityItems[].activityStartDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("이력 시작 기간"),
                                                fieldWithPath(
                                                                "result.profileActivityItems[].activityEndDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("이력 종료 기간"),
                                                fieldWithPath(
                                                                "result.profileActivityItems[].isActivityVerified")
                                                        .type(JsonFieldType.BOOLEAN)
        ...
        final CommonResponse<ProfileActivityItems> actual =
                objectMapper.readValue(
                        jsonResponse, new TypeReference<CommonResponse<ProfileActivityItems>>() {});

        final CommonResponse<ProfileActivityItems> expected =
                CommonResponse.onSuccess(profileActivityItems);
    ...
    void getProfileActivityDetail() throws Exception {
        ...
        // when
        when(profileActivityService.getProfileActivityDetail(anyLong(), anyLong()))
                .thenReturn(profileActivityDetail);
                        ...
                        .andDo(
                                restDocs.document(
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.activityCertificationAttachFileName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("증명서 파일 이름"),
                                                fieldWithPath(
                                                                "result.activityCertificationAttachFilePath")
                                                        .type(JsonFieldType.STRING)
    ...
    void addProfileActivity() throws Exception {
        ...
        final AddProfileActivityResponse addProfileActivityResponse =
                new AddProfileActivityResponse(
                        1L, "리에종", "PO", "2022.06", "2026.06", false, "이력 설명");

        // when
        when(profileActivityService.addProfileActivity(anyLong(), any()))
                .thenReturn(addProfileActivityResponse);
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<AddProfileActivityResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<AddProfileActivityResponse>>() {});

        final CommonResponse<AddProfileActivityResponse> expected =
                CommonResponse.onSuccess(addProfileActivityResponse);
    ...
    void updateProfileActivity() throws Exception {
        ...
        final ProfileActivityRequestDTO.UpdateProfileActivityRequest updateProfileActivityRequest =
                new UpdateProfileActivityRequest(
                        "리에종2", "BE", "2023.09", "2024.08", false, "이력 설명2");

        final UpdateProfileActivityResponse updateProfileActivityResponse =
                new UpdateProfileActivityResponse(
                        2L, "리에종2", "BE", "2023.09", "2024.08", false, "이력 설명2");

        // when
        when(profileActivityService.updateProfileActivity(anyLong(), anyLong(), any()))
                .thenReturn(updateProfileActivityResponse);

        final ResultActions resultActions =
                performUpdateProfileActivity(1L, updateProfileActivityRequest);
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<UpdateProfileActivityResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<UpdateProfileActivityResponse>>() {});

        final CommonResponse<UpdateProfileActivityResponse> expected =
    ...
    void removeProfileActivity() throws Exception {
        // given
        final ProfileActivityResponseDTO.RemoveProfileActivityResponse
                removeProfileActivityResponse = new RemoveProfileActivityResponse(1L);
        // when
        when(profileActivityService.removeProfileActivity(anyLong(), anyLong()))
                .thenReturn(removeProfileActivityResponse);
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<RemoveProfileActivityResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<RemoveProfileActivityResponse>>() {});

        final CommonResponse<RemoveProfileActivityResponse> expected =
                CommonResponse.onSuccess(removeProfileActivityResponse);
    ...
    void addProfileActivityCertification() throws Exception {
        ...
        final ProfileActivityCertificationResponse profileActivityCertificationResponse =
                new ProfileActivityCertificationResponse(
                        true, false, "증명서.pdf", "https://file.linkit.im/해시값.pdf");

        final MockMultipartFile profileActivityCertificationFile =
        ...
        // when
        when(profileActivityService.addProfileActivityCertification(anyLong(), anyLong(), any()))
                .thenReturn(profileActivityCertificationResponse);
                                ...
                                restDocs.document(
                                        pathParameters(
                                                parameterWithName("profileActivityId")
                                                        .description("프로필 이력 ID")),
                                        requestParts(
                                                partWithName("profileActivityCertificationFile")
                                                        .description("이력 증명 파일")),
                                        responseFields(
                                                fieldWithPath("isSuccess")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("요청 성공 여부")
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<ProfileActivityCertificationResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<
                                CommonResponse<ProfileActivityCertificationResponse>>() {});

        final CommonResponse<ProfileActivityCertificationResponse> expected =
                CommonResponse.onSuccess(profileActivityCertificationResponse);
    ...
    void removeProfileActivityCertification() throws Exception {
        // given
        final ProfileActivityResponseDTO.RemoveProfileActivityCertificationResponse
                removeProfileActivityCertificationResponse =
                        new RemoveProfileActivityCertificationResponse(1L);

        // when
        when(profileActivityService.removeProfileActivityCertification(anyLong(), anyLong()))
                .thenReturn(removeProfileActivityCertificationResponse);
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<RemoveProfileActivityCertificationResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<
                                CommonResponse<RemoveProfileActivityCertificationResponse>>() {});

        final CommonResponse<RemoveProfileActivityCertificationResponse> expected =
                CommonResponse.onSuccess(removeProfileActivityCertificationResponse);
