...
class ProfileControllerTest extends ControllerTest {
    ...
    void getProfileLeftMenu() throws Exception {
        ...
        final ProfileLeftMenu profileLeftMenu =
                new ProfileLeftMenu(profileCompletionMenu, profileBooleanMenu);
                        ...
                        .andDo(
                                restDocs.document(
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.profileCompletionMenu.profileCompletion")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("프로필 완성도 값"),

                                                // profileBooleanMenu
                                                fieldWithPath(
                                                                "result.profileBooleanMenu.isMiniProfile")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로필 미니 프로필 기입 여부"),
                                                fieldWithPath(
                                                                "result.profileBooleanMenu.isProfileSkill")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로필 스킬 기입 여부"),
                                                fieldWithPath(
                                                                "result.profileBooleanMenu.isProfileActivity")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로필 이력 기입 여부"),
                                                fieldWithPath(
                                                                "result.profileBooleanMenu.isProfilePortfolio")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로필 포트폴리오 기입 여부"),
                                                fieldWithPath(
                                                                "result.profileBooleanMenu.isProfileEducation")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로필 학력 기입 여부"),
                                                fieldWithPath(
                                                                "result.profileBooleanMenu.isProfileAwards")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로필 수상 기입 여부"),
                                                fieldWithPath(
                                                                "result.profileBooleanMenu.isProfileLicense")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로필 자격증 기입 여부"),
                                                fieldWithPath(
                                                                "result.profileBooleanMenu.isProfileLink")
                                                        .type(JsonFieldType.BOOLEAN)
        ...
        final CommonResponse<ProfileLeftMenu> actual =
                objectMapper.readValue(
                        jsonResponse, new TypeReference<CommonResponse<ProfileLeftMenu>>() {});
    ...
    void getProfileDetail() throws Exception {
        ...
        final List<ProfileCurrentStateItem> profileCurrentStates =
                Arrays.asList(firstProfileCurrentStateItem, secondProfileCurrentStateItem);
        ...
        final MvcResult mvcResult =
                resultActions
                        ...
                        .andDo(
                                restDocs.document(
                                        pathParameters(
                                                parameterWithName("emailId").description("이메일 ID")),
                                        responseFields(
                                                fieldWithPath("isSuccess")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("요청 성공 여부")
                                                ...
                                                fieldWithPath(
                                                                "result.profileInformMenu.profileCurrentStates")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("현재 프로필 상태 목록"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.profileCurrentStates[].profileStateName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로필 상태 이름"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.isProfileScrap")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description(
                                                                "프로필 스크랩 유무 (로그아웃 상태 -> 무조건 false)"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.profileScrapCount")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("프로필 스크랩 전체 개수"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.profileImagePath")
                                                        .type(JsonFieldType.STRING)
                                                ...
                                                fieldWithPath(
                                                                "result.profileInformMenu.isProfilePublic")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로필 공개 여부"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.majorPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("포지션 대분류"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.subPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("포지션 소분류"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.regionDetail")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("지역 상세 정보"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.regionDetail.cityName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("지역 시/도"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.regionDetail.divisionName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("지역 시/군/구"),

                                                // profileTeamInform
                                                fieldWithPath(
                                                                "result.profileInformMenu.profileTeamInforms[].teamName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로필 회원이 속한 팀의 팀 이름"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.profileTeamInforms[].teamCode")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로필 회원이 속한 팀의 팀 아이디 (팀 코드)"),
                                                fieldWithPath(
                                                                "result.profileInformMenu.profileTeamInforms[].teamLogoImagePath")
                                                        .type(JsonFieldType.STRING)
                                                ...
                                                fieldWithPath(
                                                                "result.profileActivityItems[].activityDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("이력 설명"),
                                                ...
                                                fieldWithPath(
                                                                "result.profileEducationItems[].educationDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("학력 설명"),
                                                ...
                                                fieldWithPath(
                                                                "result.profileAwardsItems[].profileAwardsId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("프로필 수상 ID"),
                                                fieldWithPath(
                                                                "result.profileAwardsItems[].awardsName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수상 이름"),
                                                fieldWithPath(
                                                                "result.profileAwardsItems[].awardsRanking")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수상 훈격"),
                                                fieldWithPath(
                                                ...
                                                fieldWithPath(
                                                                "result.profileAwardsItems[].awardsDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수상 설명"),
                                                ...
                                                fieldWithPath(
                                                                "result.profileLicenseItems[].licenseDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("자격증 설명"),
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<ProfileDetail> actual =
                objectMapper.readValue(
                        jsonResponse, new TypeReference<CommonResponse<ProfileDetail>>() {});
    ...
    void getHomeProfileInformMenus() throws Exception {
        // given
        final ProfileResponseDTO.ProfileInformMenus profileInformMenus =
                ProfileInformMenus.builder()
                        .profileInformMenus(
                                Arrays.asList(
                                        ProfileInformMenu.builder()
                                ...
                                restDocs.document(
                                        responseFields(
                                                ...
                                                fieldWithPath("message")
                                                        ...
                                                        .attributes(field("constraint", "문자열")),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].profileCurrentStates[].profileStateName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로필 상태 이름"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].isProfileScrap")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description(
                                                                "프로필 스크랩 여부 (자기 자신이 스크랩한 목록 조회는 무조건 true)"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].profileScrapCount")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("프로필 스크랩 전체 개수"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].profileImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로필 이미지 경로"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].memberName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("회원 이름"),
                                                fieldWithPath("result.profileInformMenus[].emailId")
                                                        ...
                                                        .description("이메일 ID"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].isProfilePublic")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로필 공개 여부"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].majorPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("포지션 대분류"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].subPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("포지션 소분류"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].regionDetail.cityName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("활동지역 시/도"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].regionDetail.divisionName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("활동지역 시/군/구"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].profileTeamInforms[].teamName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("소속 팀 이름"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].profileTeamInforms[].teamCode")
                                                        .type(JsonFieldType.STRING)
                                                        .description("소속 팀 아이디 (팀 코드)"),
                                                fieldWithPath(
                                                                "result.profileInformMenus[].profileTeamInforms[].teamLogoImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("소속 팀 로고 이미지 경로"))))
                        .andReturn();

        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<ProfileInformMenus> actual =
                objectMapper.readValue(
                        jsonResponse, new TypeReference<CommonResponse<ProfileInformMenus>>() {});

        final CommonResponse<ProfileInformMenus> expected =
