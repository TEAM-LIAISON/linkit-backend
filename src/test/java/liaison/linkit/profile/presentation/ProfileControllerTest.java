...
class ProfileControllerTest extends ControllerTest {
    ...
    void getProfileDetail() throws Exception {
        ...
        final List<ProfileCurrentStateItem> profileCurrentStates = Arrays.asList(firstProfileCurrentStateItem,
            secondProfileCurrentStateItem);
        ...
        final ProfilePortfolioResponseDTO.ProfilePortfolioItem firstProfilePortfolioItem
            = new ProfilePortfolioItem(1L, "프로젝트 이름", "프로젝트 한 줄 소개", ProjectSize.PERSONAL, "2023.02", "2023.04", false,
            Arrays.asList("컨텐츠 제작", "브랜딩", "계정 관리"), "logo.png");

        final ProfilePortfolioResponseDTO.ProfilePortfolioItem secondProfilePortfolioItem
            = new ProfilePortfolioItem(2L, "프로젝트 이름", "프로젝트 한 줄 소개", ProjectSize.TEAM, "2023.03", "2023.06", true,
            Arrays.asList("컨텐츠 제작", "브랜딩", "계정 관리"), "logo.png");
