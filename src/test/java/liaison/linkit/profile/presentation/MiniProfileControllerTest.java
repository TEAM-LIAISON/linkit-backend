...
class MiniProfileControllerTest extends ControllerTest {
    ...
    @MockBean private MiniProfileService miniProfileService;
    ...
    void getMiniProfileDetail() throws Exception {
        ...
        final ProfilePositionItem profilePositionItem = new ProfilePositionItem("개발", "백엔드 개발자");
        ...
        final MiniProfileResponseDTO.MiniProfileDetailResponse miniProfileDetailResponse =
                new MiniProfileDetailResponse(
                        1L,
                        "https://image.linkit.im/profile.png",
                        "권동민",
                        profilePositionItem,
                        "서울특별시",
                        "동작구",
        ...
        // when
        when(miniProfileService.getMiniProfileDetail(anyLong()))
                .thenReturn(miniProfileDetailResponse);
                        ...
                        .andDo(
                                restDocs.document(
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.profilePositionItem.majorPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("포지션 대분류"),
                                                fieldWithPath(
                                                                "result.profilePositionItem.subPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("포지션 소분류"),
                                                ...
                                                fieldWithPath(
                                                                "result.profileCurrentStateItems.profileCurrentStates[]")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로필 현재 상태 목록"),
                                                fieldWithPath(
                                                                "result.profileCurrentStateItems.profileCurrentStates[].profileStateName")
                                                        .type(JsonFieldType.STRING)
        ...
        final CommonResponse<MiniProfileDetailResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<MiniProfileDetailResponse>>() {});

        final CommonResponse<MiniProfileDetailResponse> expected =
                CommonResponse.onSuccess(miniProfileDetailResponse);
    ...
    void updateMiniProfile() throws Exception {
        ...
        final UpdateMiniProfileResponse updateMiniProfileResponse =
                new UpdateMiniProfileResponse(
                        ...
                        "활동지역 시/도",
                        "활동지역 시/군/구",
                        Arrays.asList("팀 찾는 중", "아이디어 찾는 중"),
                        true);

        final MockMultipartFile profileImage =
        ...
        final UpdateMiniProfileRequest updateMiniProfileRequest =
                new UpdateMiniProfileRequest(
                        "대분류 포지션",
                        "소분류 포지션",
                        "시/도",
                        "시/군/구",
                        Arrays.asList("팀 찾는 중", "팀원 찾는 중"),
                        true);
        ...
        final MockMultipartFile createRequest =
                new MockMultipartFile(
                        ...
                        "application/json",
                        objectMapper
                                .writeValueAsString(updateMiniProfileRequest)
                                .getBytes(StandardCharsets.UTF_8));

        // when
        when(miniProfileService.updateMiniProfile(anyLong(), any(), any()))
                .thenReturn(updateMiniProfileResponse);
                        ...
                        .andDo(
                                restDocs.document(
                                        requestParts(
                                                ...
                                                partWithName("updateMiniProfileRequest")
                                                        .description("미니 프로필 수정 정보 객체")),
                                        responseFields(
                                                fieldWithPath("isSuccess")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("요청 성공 여부")
