...
class ProfileAwardsControllerTest extends ControllerTest {
    ...
    @MockBean private ProfileAwardsService profileAwardsService;
    ...
    private ResultActions performGetProfileAwardsDetail(final Long profileAwardsId)
            throws Exception {
        return mockMvc.perform(
                RestDocumentationRequestBuilders.get(
                                "/api/v1/profile/awards/{profileAwardsId}", profileAwardsId)
                        .header(AUTHORIZATION, MEMBER_TOKENS.getAccessToken())
                        .cookie(COOKIE));
    }

    private ResultActions performAddProfileAwards(final AddProfileAwardsRequest request)
            throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performUpdateProfileAwards(
            final Long profileAwardsId, final UpdateProfileAwardsRequest request) throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performRemoveAwardsCertification(final Long profileAwardsId)
            throws Exception {
        return mockMvc.perform(
    ...
    void getProfileAwardsItems() throws Exception {
        ...
        final CommonResponse<ProfileAwardsItems> actual =
                objectMapper.readValue(
                        jsonResponse, new TypeReference<CommonResponse<ProfileAwardsItems>>() {});

        final CommonResponse<ProfileAwardsItems> expected =
                CommonResponse.onSuccess(profileAwardsItems);
    ...
    void getProfileAwardsDetail() throws Exception {
        ...
        // when
        when(profileAwardsService.getProfileAwardsDetail(anyLong(), anyLong()))
                .thenReturn(profileAwardsDetail);
                        ...
                        .andDo(
                                restDocs.document(
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.awardsCertificationAttachFileName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수상 증명서 파일 이름"),
                                                fieldWithPath(
                                                                "result.awardsCertificationAttachFilePath")
                                                        .type(JsonFieldType.STRING)
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<ProfileAwardsDetail> actual =
                objectMapper.readValue(
                        jsonResponse, new TypeReference<CommonResponse<ProfileAwardsDetail>>() {});

        final CommonResponse<ProfileAwardsDetail> expected =
                CommonResponse.onSuccess(profileAwardsDetail);
    ...
    void addProfileAwards() throws Exception {
        ...
        // when
        when(profileAwardsService.addProfileAwards(anyLong(), any()))
                .thenReturn(addProfileAwardsResponse);
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<AddProfileAwardsResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<AddProfileAwardsResponse>>() {});

        final CommonResponse<AddProfileAwardsResponse> expected =
                CommonResponse.onSuccess(addProfileAwardsResponse);
    ...
    void updateProfileAwards() throws Exception {
        ...
        final UpdateProfileAwardsResponse updateProfileActivityResponse =
                new UpdateProfileAwardsResponse(
                        1L, "수상 이름", "수상 훈격", "수상 시기", "수상 주최 및 주관", "수상 설명");

        // when
        when(profileAwardsService.updateProfileAwards(anyLong(), anyLong(), any()))
                .thenReturn(updateProfileActivityResponse);

        final ResultActions resultActions =
                performUpdateProfileAwards(1L, updateProfileAwardsRequest);
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<UpdateProfileAwardsResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<UpdateProfileAwardsResponse>>() {});

        final CommonResponse<UpdateProfileAwardsResponse> expected =
    ...
    void removeProfileAwards() throws Exception {
        ...
        // when
        when(profileAwardsService.removeProfileAwards(anyLong(), anyLong()))
                .thenReturn(removeProfileAwardsResponse);
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<RemoveProfileAwardsResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<RemoveProfileAwardsResponse>>() {});

        final CommonResponse<RemoveProfileAwardsResponse> expected =
                CommonResponse.onSuccess(removeProfileAwardsResponse);
    ...
    void addProfileAwardsCertification() throws Exception {
        ...
        final ProfileAwardsCertificationResponse profileAwardsCertificationResponse =
                new ProfileAwardsCertificationResponse(
                        true, false, "증명서.pdf", "https://file.linkit.im/해시값.pdf");

        final MockMultipartFile profileAwardsCertificationFile =
        ...
        // when
        when(profileAwardsService.addProfileAwardsCertification(anyLong(), anyLong(), any()))
                .thenReturn(profileAwardsCertificationResponse);

        final ResultActions resultActions =
                mockMvc.perform(
                        RestDocumentationRequestBuilders.multipart(
                                        "/api/v1/profile/awards/certification/{profileAwardsId}",
                                        profileAwardsId)
                                ...
                                restDocs.document(
                                        pathParameters(
                                                parameterWithName("profileAwardsId")
                                                        .description("프로필 수상 ID")),
                                        requestParts(
                                                partWithName("profileAwardsCertificationFile")
                                                        .description("수상 증명 파일")),
                                        responseFields(
                                                fieldWithPath("isSuccess")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("요청 성공 여부")
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<ProfileAwardsCertificationResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<ProfileAwardsCertificationResponse>>() {});

        final CommonResponse<ProfileAwardsCertificationResponse> expected =
                CommonResponse.onSuccess(profileAwardsCertificationResponse);
    ...
    void removeProfileAwardsCertification() throws Exception {
        // given
        final ProfileAwardsResponseDTO.RemoveProfileAwardsCertificationResponse
                removeProfileAwardsCertificationResponse =
                        new RemoveProfileAwardsCertificationResponse(1L);

        // when
        when(profileAwardsService.removeProfileAwardsCertification(anyLong(), anyLong()))
                .thenReturn(removeProfileAwardsCertificationResponse);
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<RemoveProfileAwardsCertificationResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<
                                CommonResponse<RemoveProfileAwardsCertificationResponse>>() {});

        final CommonResponse<RemoveProfileAwardsCertificationResponse> expected =
                CommonResponse.onSuccess(removeProfileAwardsCertificationResponse);
