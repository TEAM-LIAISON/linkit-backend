...
public class ProfilePortfolioControllerTest extends ControllerTest {
    ...
    @MockBean private ProfilePortfolioService profilePortfolioService;
    ...
    private ResultActions performGetProfilePortfolioViewItems(final String emailId)
            throws Exception {
        return mockMvc.perform(
                RestDocumentationRequestBuilders.get(
                                "/api/v1/profile/portfolio/view/{emailId}", emailId)
                        .header(AUTHORIZATION, MEMBER_TOKENS.getAccessToken())
                        .cookie(COOKIE));
    }

    private ResultActions performGetProfilePortfolioDetail(final Long profilePortfolioId)
            throws Exception {
        return mockMvc.perform(
                RestDocumentationRequestBuilders.get(
                                "/api/v1/profile/portfolio/{profilePortfolioId}",
                                profilePortfolioId)
                        .header(AUTHORIZATION, MEMBER_TOKENS.getAccessToken())
                        .cookie(COOKIE));
    }

    private ResultActions performRemoveProfilePortfolio(final Long profilePortfolioId)
            throws Exception {
        return mockMvc.perform(
    ...
    void getProfilePortfolioItems() throws Exception {
        ...
        final ProfilePortfolioResponseDTO.ProfilePortfolioItem firstProfilePortfolioItem =
                new ProfilePortfolioItem(
                        1L,
                        "프로젝트 이름",
                        "프로젝트 한 줄 소개",
                        ProjectSize.PERSONAL,
                        "2023.02",
                        "2023.04",
                        false,
                        Arrays.asList("컨텐츠 제작", "브랜딩", "계정 관리"),
                        "logo.png");
        ...
        final ProfilePortfolioResponseDTO.ProfilePortfolioItems profilePortfolioItems =
                new ProfilePortfolioItems(
                        Arrays.asList(firstProfilePortfolioItem, secondProfilePortfolioItem));

        // when
        when(profilePortfolioService.getProfilePortfolioItems(anyLong()))
                .thenReturn(profilePortfolioItems);
                        ...
                        .andDo(
                                restDocs.document(
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.profilePortfolioItems[].profilePortfolioId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("내 수상 ID"),
                                                fieldWithPath(
                                                                "result.profilePortfolioItems[].projectName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 이름"),
                                                fieldWithPath(
                                                                "result.profilePortfolioItems[].projectLineDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 한 줄 소개"),
                                                fieldWithPath(
                                                                "result.profilePortfolioItems[].projectSize")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 규모"),
                                                fieldWithPath(
                                                                "result.profilePortfolioItems[].projectStartDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 시작 날짜"),
                                                fieldWithPath(
                                                                "result.profilePortfolioItems[].projectEndDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 종료 날짜"),
                                                fieldWithPath(
                                                                "result.profilePortfolioItems[].isProjectInProgress")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로젝트 진행 여부"),
                                                fieldWithPath(
                                                                "result.profilePortfolioItems[].projectRoles[]")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로젝트 역할 배열"),
                                                fieldWithPath(
                                                                "result.profilePortfolioItems[].projectRepresentImagePath")
                                                        .type(JsonFieldType.STRING)
        ...
        final CommonResponse<ProfilePortfolioItems> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<ProfilePortfolioItems>>() {});

        final CommonResponse<ProfilePortfolioItems> expected =
                CommonResponse.onSuccess(profilePortfolioItems);
    ...
    void getProfilePortfolioViewItems() throws Exception {
        ...
        // when
        when(profilePortfolioService.getProfilePortfolioViewItems(any()))
                .thenReturn(profilePortfolioItems);
    ...
    void getProfilePortfolioDetail() throws Exception {
        ...
        final List<ProjectSkillName> projectSkillNames =
                Arrays.asList(new ProjectSkillName("Java"), new ProjectSkillName("Figma"));

        final List<PortfolioSubImage> portfolioSubImages =
                Arrays.asList(
        ...
        // when
        when(profilePortfolioService.getProfilePortfolioDetailInLogoutState(anyLong()))
                .thenReturn(profilePortfolioDetail);
                                ...
                                restDocs.document(
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath("result.isProjectInProgress")
                                                        ...
                                                        .description("프로젝트 진행 여부"),
                                                fieldWithPath(
                                                                "result.projectRoleAndContributions[]")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로젝트 역할 및 기여도 목록"),
                                                fieldWithPath(
                                                                "result.projectRoleAndContributions[].projectRole")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 역할"),
                                                fieldWithPath(
                                                                "result.projectRoleAndContributions[].projectContribution")
                                                        .type(JsonFieldType.STRING)
                                                        .description(
                                                                "프로젝트 기여도 (예: HIGH, UPPER_MIDDLE, MIDDLE, LOWER_MIDDLE, LOWER)"),
                                                fieldWithPath("result.projectSkillNames[]")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로젝트 스킬 이름 목록"),
                                                fieldWithPath(
                                                                "result.projectSkillNames[].projectSkillName")
                                                        .type(JsonFieldType.STRING)
                                                ...
                                                fieldWithPath(
                                                                "result.projectLinkNameAndUrls[].projectLinkName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 링크 제목"),
                                                fieldWithPath(
                                                                "result.projectLinkNameAndUrls[].projectLinkUrl")
                                                        .type(JsonFieldType.STRING)
                                                ...
                                                fieldWithPath(
                                                                "result.portfolioImages.projectRepresentImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 대표 이미지 경로"),
                                                fieldWithPath(
                                                                "result.portfolioImages.portfolioSubImages")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("포트폴리오 서브 이미지 목록"),
                                                fieldWithPath(
                                                                "result.portfolioImages.portfolioSubImages[].projectSubImagePath")
                                                        .type(JsonFieldType.STRING)
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<ProfilePortfolioDetail> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<ProfilePortfolioDetail>>() {});

        final CommonResponse<ProfilePortfolioDetail> expected =
                CommonResponse.onSuccess(profilePortfolioDetail);

        // then
        assertThat(actual).usingRecursiveComparison().isEqualTo(expected);
    }

    @DisplayName("회원이 나의 포트폴리오를 생성할 수 있다.")
    @Test
    void addProfilePortfolio() throws Exception {
        // given
        // 프로젝트 역할 및 기여도
        final List<ProfilePortfolioRequestDTO.ProjectRoleAndContribution>
                projectRoleAndContributions =
                        Arrays.asList(
        ...
        // 프로젝트 스킬
        final List<ProfilePortfolioRequestDTO.ProjectSkillName> projectSkillNames =
                Arrays.asList(
        ...
        final List<ProfilePortfolioRequestDTO.ProjectLinkNameAndUrls> projectLinkNameAndUrls =
                Arrays.asList(
        ...
        final MockMultipartFile projectRepresentImage =
        ...
        final MockMultipartFile createRequest =
                new MockMultipartFile(
                        ...
                        "application/json",
                        objectMapper
                                .writeValueAsString(addProfilePortfolioRequest)
                                .getBytes(StandardCharsets.UTF_8));

        final List<ProfilePortfolioResponseDTO.ProjectRoleAndContribution>
                projectRoleAndContributionsResponse =
                        Arrays.asList(
        ...
        final List<ProfilePortfolioResponseDTO.ProjectSkillName> projectSkillNamesResponse =
                Arrays.asList(
        ...
        final ProfilePortfolioResponseDTO.PortfolioImages portfolioImages =
                new PortfolioImages(
                        "프로젝트 대표 이미지 경로",
                        Arrays.asList(
        ...
        final List<ProfilePortfolioResponseDTO.ProjectLinkNameAndUrls>
                projectLinkNameAndUrlsResponse =
                        Arrays.asList(
                                new ProfilePortfolioResponseDTO.ProjectLinkNameAndUrls(
                                        "링크 이름", "링크 주소"),
                                new ProfilePortfolioResponseDTO.ProjectLinkNameAndUrls(
                                        "링크 이름", "링크 주소"));

        final AddProfilePortfolioResponse addProfilePortfolioResponse =
                new AddProfilePortfolioResponse(
                        "프로젝트 이름",
                        "프로젝트 한 줄 소개",
                        ProjectSize.PERSONAL,
                        3,
                        ...
                        false,
                        projectRoleAndContributionsResponse,
                        projectSkillNamesResponse,
                        projectLinkNameAndUrlsResponse,
                        "프로젝트 설명",
                        portfolioImages);

        // when
        when(profilePortfolioService.addProfilePortfolio(anyLong(), any(), any(), any()))
                .thenReturn(addProfilePortfolioResponse);
                                ...
                                restDocs.document(
                                        ...
                                        requestPartFields(
                                                ...
                                                fieldWithPath("projectName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 이름"),
                                                fieldWithPath("projectLineDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 한 줄 소개"),
                                                fieldWithPath("projectSize")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 규모 (예: PERSONAL, TEAM)"),
                                                fieldWithPath("projectHeadCount")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("프로젝트 인원 수"),
                                                fieldWithPath("projectTeamComposition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 팀 구성"),
                                                fieldWithPath("projectStartDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 시작 날짜"),
                                                fieldWithPath("projectEndDate")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 종료 날짜"),
                                                fieldWithPath("isProjectInProgress")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("프로젝트 진행 여부"),
                                                fieldWithPath("projectRoleAndContributions")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로젝트 역할 및 기여도 목록"),
                                                fieldWithPath(
                                                                "projectRoleAndContributions[].projectRole")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 역할"),
                                                fieldWithPath(
                                                                "projectRoleAndContributions[].projectContribution")
                                                        .type(JsonFieldType.STRING)
                                                        .description(
                                                                "프로젝트 기여도 (예: HIGH, UPPER_MIDDLE, MIDDLE, LOWER_MIDDLE, LOWER)"),
                                                fieldWithPath("projectSkillNames")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로젝트 스킬 이름 목록"),
                                                fieldWithPath(
                                                                "projectSkillNames[].projectSkillName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 스킬 이름"),
                                                fieldWithPath("projectLinkNameAndUrls")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("프로젝트 링크 이름 및 링크 경로"),
                                                fieldWithPath(
                                                                "projectLinkNameAndUrls[].projectLinkName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 링크 이름"),
                                                fieldWithPath(
                                                                "projectLinkNameAndUrls[].projectLinkUrl")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 링크 경로"),
                                                fieldWithPath("projectDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 설명")),
                                        responseFields(
                                                fieldWithPath("isSuccess")
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<AddProfilePortfolioResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<AddProfilePortfolioResponse>>() {});

        final CommonResponse<AddProfilePortfolioResponse> expected =
                CommonResponse.onSuccess(addProfilePortfolioResponse);
    ...
    void updateProfilePortfolio() throws Exception {
        ...
        final UpdateProfilePortfolioRequest updateProfilePortfolioRequest =
                UpdateProfilePortfolioRequest.builder()
                        ...
                        .portfolioImages(
                                ProfilePortfolioRequestDTO.PortfolioImages.builder()
                                        .projectRepresentImagePath("포트폴리오 대표 이미지 경로")
                                        .portfolioSubImages(
                                                Arrays.asList(
                                                        ProfilePortfolioRequestDTO.PortfolioSubImage
                                                                .builder()
                                                                .projectSubImagePath(
                                                                        "포트폴리오 보조 이미지 경로")
                                                                .build(),
        ...
        final MockMultipartFile createRequest =
                new MockMultipartFile(
                        ...
                        "application/json",
                        objectMapper
                                .writeValueAsString(updateProfilePortfolioRequest)
                                .getBytes(StandardCharsets.UTF_8));
        ...
        final UpdateProfilePortfolioResponse updateProfilePortfolioResponse =
                new UpdateProfilePortfolioResponse(
                        1L,
                        "수정 프로젝트 이름",
                        "수정 프로젝트 한 줄 소개",
                        ProjectSize.TEAM,
        ...
        // when
        when(profilePortfolioService.updateProfilePortfolio(
                        anyLong(), anyLong(), any(), any(), any()))
                .thenReturn(updateProfilePortfolioResponse);
                                ...
                                restDocs.document(
                                        ...
                                        requestPartFields(
                                                ...
                                                fieldWithPath("projectDescription")
                                                        .type(JsonFieldType.STRING)
                                                        .description("프로젝트 설명"),
                                                fieldWithPath("portfolioImages")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("프로덕트 이미지 정보"),
                                                fieldWithPath(
                                                                "portfolioImages.projectRepresentImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("유지되는 대표 이미지 경로"),
                                                fieldWithPath("portfolioImages.portfolioSubImages")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("유지되는 보조 이미지 목록"),
                                                fieldWithPath(
                                                                "portfolioImages.portfolioSubImages[].projectSubImagePath")
                                                        .type(JsonFieldType.STRING)
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<UpdateProfilePortfolioResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<UpdateProfilePortfolioResponse>>() {});

        final CommonResponse<UpdateProfilePortfolioResponse> expected =
                CommonResponse.onSuccess(updateProfilePortfolioResponse);
    ...
    void removeProfilePortfolio() throws Exception {
        // given
        final ProfilePortfolioResponseDTO.RemoveProfilePortfolioResponse
                removeProfilePortfolioResponse = new RemoveProfilePortfolioResponse(1L);

        // when
        when(profilePortfolioService.removeProfilePortfolio(anyLong(), anyLong()))
                .thenReturn(removeProfilePortfolioResponse);
        ...
        // JSON 응답에서 result 객체를 추출 및 검증
        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<RemoveProfilePortfolioResponse> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<RemoveProfilePortfolioResponse>>() {});

        final CommonResponse<RemoveProfilePortfolioResponse> expected =
                CommonResponse.onSuccess(removeProfilePortfolioResponse);
