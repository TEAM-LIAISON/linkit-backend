...
public class MatchingControllerTest extends ControllerTest {
    ...
    @MockBean private SendMatchingService sendMatchingService;

    @MockBean private ReceiveMatchingService receiveMatchingService;
    ...
    private ResultActions performPostAddMatching(final AddMatchingRequest addMatchingRequest)
            throws Exception {
    ...
    private ResultActions performPostUpdateMatchingStatusType(
            final Long matchingId,
            final UpdateMatchingStatusTypeRequest updateMatchingStatusTypeRequest)
            throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performGetSelectMatchingRequestToProfileMenu(final String emailId)
            throws Exception {
        return mockMvc.perform(
                RestDocumentationRequestBuilders.get(
                                "/api/v1/matching/profile/{emailId}/select/request/menu", emailId)
                        .header(AUTHORIZATION, MEMBER_TOKENS.getAccessToken())
                        .cookie(COOKIE));
    }

    private ResultActions performGetSelectMatchingRequestToTeamMenu(final String teamCode)
            throws Exception {
        return mockMvc.perform(
                RestDocumentationRequestBuilders.get(
                                "/api/v1/matching/team/{teamCode}/select/request/menu", teamCode)
                        .header(AUTHORIZATION, MEMBER_TOKENS.getAccessToken())
                        .cookie(COOKIE));
    }

    private ResultActions performGetReceivedMatchingMenu(
            ReceiverType receiverType, int page, int size) throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performGetMatchingRequestedMenu(SenderType senderType, int page, int size)
            throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performUpdateReceivedMatchingStateRead(
            final UpdateReceivedMatchingReadRequest request) throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performDeleteReceivedMatchingItems(
            final DeleteReceivedMatchingRequest request) throws Exception {
        return mockMvc.perform(
    ...
    private ResultActions performDeleteRequestedMatchingItems(
            final DeleteRequestedMatchingRequest request) throws Exception {
        return mockMvc.perform(
    ...
    void addMatching() throws Exception {
        // given
        final AddMatchingRequest addMatchingRequest =
                AddMatchingRequest.builder()
        ...
        final MatchingResponseDTO.AddMatchingResponse addMatchingResponse =
                AddMatchingResponse.builder()
                        .matchingId(1L)
                        .senderType(SenderType.PROFILE)
                        .receiverType(ReceiverType.PROFILE)
                                ...
                                restDocs.document(
                                        requestFields(
                                                ...
                                                fieldWithPath("receiverType")
                                                        .type(JsonFieldType.STRING)
                                                        .description(
                                                                "수신자 타입 - [PROFILE, TEAM, ANNOUNCEMENT]")
                                                        .attributes(
                                                                field(
                                                                        "constraint",
                                                                        "PROFILE, TEAM 또는 ANNOUNCEMENT")),
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.senderProfileInformation.profileImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 프로필 이미지 경로"),
                                                fieldWithPath(
                                                                "result.senderProfileInformation.memberName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 이름"),
                                                fieldWithPath(
                                                                "result.senderProfileInformation.emailId")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 유저 아이디"),
                                                fieldWithPath(
                                                                "result.senderProfileInformation.profilePositionDetail")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("발신자 프로필 포지션 상세 정보"),
                                                fieldWithPath(
                                                                "result.senderProfileInformation.profilePositionDetail.majorPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .optional()
                                                        .description("발신자 포지션 대분류 (null 가능)"),
                                                fieldWithPath(
                                                                "result.senderProfileInformation.profilePositionDetail.subPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .optional()
                                                ...
                                                fieldWithPath(
                                                                "result.senderTeamInformation.teamCode")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 팀 아이디 (팀 코드)"),
                                                fieldWithPath(
                                                                "result.senderTeamInformation.teamName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 팀 이름"),
                                                fieldWithPath(
                                                                "result.senderTeamInformation.teamLogoImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 팀 로고 이미지 경로"),
                                                fieldWithPath(
                                                                "result.senderTeamInformation.teamScaleItem")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("발신자 팀 규모 정보"),
                                                fieldWithPath(
                                                                "result.senderTeamInformation.teamScaleItem.teamScaleName")
                                                        .type(JsonFieldType.STRING)
                                                ...
                                                fieldWithPath(
                                                                "result.receiverProfileInformation.profileImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 프로필 이미지 경로"),
                                                fieldWithPath(
                                                                "result.receiverProfileInformation.memberName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 이름"),
                                                fieldWithPath(
                                                                "result.receiverProfileInformation.emailId")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 유저 아이디"),
                                                fieldWithPath(
                                                                "result.receiverProfileInformation.profilePositionDetail")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("수신자 프로필 포지션 상세 정보"),
                                                fieldWithPath(
                                                                "result.receiverProfileInformation.profilePositionDetail.majorPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .optional()
                                                        .description("수신자 포지션 대분류 (null 가능)"),
                                                fieldWithPath(
                                                                "result.receiverProfileInformation.profilePositionDetail.subPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .optional()
                                                ...
                                                fieldWithPath(
                                                                "result.receiverTeamInformation.teamCode")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 팀 아이디 (팀 코드)"),
                                                fieldWithPath(
                                                                "result.receiverTeamInformation.teamName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 팀 이름"),
                                                fieldWithPath(
                                                                "result.receiverTeamInformation.teamLogoImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 팀 로고 이미지 경로"),
                                                fieldWithPath(
                                                                "result.receiverTeamInformation.teamScaleItem")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("수신자 팀 규모 정보"),
                                                fieldWithPath(
                                                                "result.receiverTeamInformation.teamScaleItem.teamScaleName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 팀 규모명"),

                                                // ----- receiverAnnouncementInformation 추가
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("수신자 공고 정보"),
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation.teamMemberAnnouncementId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("공고 아이디"),
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation.teamName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 올림 팀의 이름"),
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation.announcementTitle")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 제목"),
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation.teamLogoImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 올림 팀의 로고 이미지 경로"),
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation.announcementPositionItem")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("공고 포지션 정보"),
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation.announcementPositionItem.majorPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 포지션 대분류"),
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation.announcementPositionItem.subPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 포지션 소분류"),
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation.announcementSkillNames")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("공고 요구 스킬 목록"),
                                                fieldWithPath(
                                                                "result.receiverAnnouncementInformation.announcementSkillNames[].announcementSkillName")
                                                        .type(JsonFieldType.STRING)
                                                ...
                                                fieldWithPath("result.matchingStatusType")
                                                        .type(JsonFieldType.STRING)
                                                        .description(
                                                                "매칭 상태 - [REQUESTED, COMPLETED 등]"),
                                                fieldWithPath("result.receiverReadStatus")
                                                        .type(JsonFieldType.STRING)
                                                        .description(
                                                                "수신자 읽음 상태 - [UNREAD_REQUESTED_MATCHING, READ_COMPLETED_MATCHING 등]"))))
                        .andReturn();
    }
    ...
    void updateMatchingStatusTypeResponse() throws Exception {
        // given
        final UpdateMatchingStatusTypeRequest updateMatchingStatusTypeRequest =
                UpdateMatchingStatusTypeRequest.builder()
                        .matchingStatusType(MatchingStatusType.COMPLETED)
                        .build();

        final UpdateMatchingStatusTypeResponse updateMatchingStatusTypeResponse =
                UpdateMatchingStatusTypeResponse.builder()
                        .matchingId(1L)
                        .matchingStatusType(MatchingStatusType.COMPLETED)
                        .build();
        // when
        when(receiveMatchingService.updateMatchingStatusType(anyLong(), anyLong(), any()))
                .thenReturn(updateMatchingStatusTypeResponse);

        final ResultActions resultActions =
                performPostUpdateMatchingStatusType(1L, updateMatchingStatusTypeRequest);
        // then
                                ...
                                restDocs.document(
                                        ...
                                        requestFields(
                                                fieldWithPath("matchingStatusType")
                                                        .type(JsonFieldType.STRING)
                                                        .description(
                                                                "매칭 상태 타입 (COMPLETED, DENIED, REQUESTED)")
                                                        .attributes(
                                                                field(
                                                                        "constraint",
                                                                        "(COMPLETED, DENIED) 2개 중에 1개"))),
                                        responseFields(
                                                fieldWithPath("isSuccess")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("요청 성공 여부")
    ...
    void getSelectMatchingRequestToProfileMenu() throws Exception {
        ...
        // given
        final SelectMatchingRequestToProfileMenu selectMatchingRequestToProfileMenu =
                SelectMatchingRequestToProfileMenu.builder()
        ...
        // when
        when(sendMatchingService.selectMatchingRequestToProfileMenu(anyLong(), any()))
                .thenReturn(selectMatchingRequestToProfileMenu);
    ...
    void getSelectMatchingRequestToTeamMenu() throws Exception {
        // given
        final SelectMatchingRequestToTeamMenu selectMatchingRequestToTeamMenu =
                SelectMatchingRequestToTeamMenu.builder()
                        .isTeamInformationExists(true)
                        .senderProfileInformation(
                                SenderProfileInformation.builder()
                                        .profileImagePath("발신자 프로필 이미지 경로")
        ...
        // when
        when(sendMatchingService.selectMatchingRequestToTeamMenu(anyLong(), any()))
                .thenReturn(selectMatchingRequestToTeamMenu);
    ...
    void getMatchingNotificationMenu() throws Exception {
        // given
        final MatchingNotificationMenu matchingNotificationMenu =
                MatchingNotificationMenu.builder()
                        .receivedMatchingNotificationCount(10)
                        .requestedMatchingNotificationCount(12)
                        .build();

        // when
        when(matchingService.getMatchingNotificationMenu(any()))
                .thenReturn(matchingNotificationMenu);
                                ...
                                restDocs.document(
                                        responseFields(
                                                ...
                                                fieldWithPath("message")
                                                        ...
                                                        .attributes(field("constraint", "문자열")),
                                                subsectionWithPath(
                                                                "result.receivedMatchingNotificationCount")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("수신함 안읽은 알림 개수"),
                                                subsectionWithPath(
                                                                "result.requestedMatchingNotificationCount")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("발신함 안읽은 알림 개수"))))
                        .andReturn();

        final String jsonResponse = mvcResult.getResponse().getContentAsString();
        final CommonResponse<MatchingNotificationMenu> actual =
                objectMapper.readValue(
                        jsonResponse,
                        new TypeReference<CommonResponse<MatchingNotificationMenu>>() {});

        final CommonResponse<MatchingNotificationMenu> expected =
                CommonResponse.onSuccess(matchingNotificationMenu);
    ...
    void getReceivedMatchingMenu() throws Exception {
        ReceivedMatchingMenu receivedMatchingMenu1 =
                ReceivedMatchingMenu.builder()
                        .matchingId(1L)
                        .senderType(SenderType.PROFILE)
                        .receiverType(ReceiverType.PROFILE)
        ...
        ReceivedMatchingMenu receivedMatchingMenu2 =
                ReceivedMatchingMenu.builder()
                        .matchingId(2L)
        ...
        List<ReceivedMatchingMenu> receivedMatchingMenus =
                Arrays.asList(receivedMatchingMenu1, receivedMatchingMenu2);
        Page<ReceivedMatchingMenu> matchingReceivedMenusPage =
                new PageImpl<>(
                        receivedMatchingMenus, PageRequest.of(0, 20), receivedMatchingMenus.size());

        when(receiveMatchingService.getReceivedMatchingMenuResponse(
                        anyLong(), any(), any(Pageable.class)))
                .thenReturn(matchingReceivedMenusPage);

        final ResultActions resultActions =
                performGetReceivedMatchingMenu(ReceiverType.PROFILE, 0, 20);
                                ...
                                restDocs.document(
                                        queryParameters(
                                                parameterWithName("receiverType")
                                                        .optional()
                                                        .description(
                                                                "수신자 타입 (선택적) - [PROFILE, TEAM, ANNOUNCEMENT] 3개"),
                                        ...
                                        responseFields(
                                                ...
                                                // ----- senderProfileInformation
                                                fieldWithPath(
                                                                "result.content[].senderProfileInformation")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("발신자 프로필 정보"),
                                                fieldWithPath(
                                                                "result.content[].senderProfileInformation.profileImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 프로필 이미지 경로"),
                                                fieldWithPath(
                                                                "result.content[].senderProfileInformation.memberName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 이름"),
                                                fieldWithPath(
                                                                "result.content[].senderProfileInformation.emailId")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 유저 아이디"),
                                                fieldWithPath(
                                                                "result.content[].senderProfileInformation.profilePositionDetail")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("발신자 프로필 포지션 정보"),
                                                fieldWithPath(
                                                                "result.content[].senderProfileInformation.profilePositionDetail.majorPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .optional()
                                                        .description("발신자 포지션 대분류 (null 가능)"),
                                                fieldWithPath(
                                                                "result.content[].senderProfileInformation.profilePositionDetail.subPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .optional()
                                                        .description("발신자 포지션 소분류 (null 가능)"),
                                                ...
                                                // ----- senderTeamInformation
                                                fieldWithPath(
                                                                "result.content[].senderTeamInformation")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("발신자 팀 정보"),
                                                fieldWithPath(
                                                                "result.content[].senderTeamInformation.teamCode")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 팀 아이디 (팀 코드)"),
                                                fieldWithPath(
                                                                "result.content[].senderTeamInformation.teamName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 팀 이름"),
                                                fieldWithPath(
                                                                "result.content[].senderTeamInformation.teamLogoImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 팀 로고 이미지 경로"),
                                                fieldWithPath(
                                                                "result.content[].senderTeamInformation.teamScaleItem")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("발신자 팀 규모 정보"),
                                                fieldWithPath(
                                                                "result.content[].senderTeamInformation.teamScaleItem.teamScaleName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("발신자 팀 규모명"),

                                                // ----- receiverProfileInformation
                                                fieldWithPath(
                                                                "result.content[].receiverProfileInformation")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("수신자 프로필 정보"),
                                                fieldWithPath(
                                                                "result.content[].receiverProfileInformation.profileImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 프로필 이미지 경로"),
                                                fieldWithPath(
                                                                "result.content[].receiverProfileInformation.memberName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 이름"),
                                                fieldWithPath(
                                                                "result.content[].receiverProfileInformation.emailId")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 유저 아이디"),
                                                fieldWithPath(
                                                                "result.content[].receiverProfileInformation.profilePositionDetail")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("수신자 프로필 포지션 정보"),
                                                fieldWithPath(
                                                                "result.content[].receiverProfileInformation.profilePositionDetail.majorPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .optional()
                                                        .description("수신자 포지션 대분류 (null 가능)"),
                                                fieldWithPath(
                                                                "result.content[].receiverProfileInformation.profilePositionDetail.subPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .optional()
                                                        .description("수신자 포지션 소분류 (null 가능)"),
                                                ...
                                                // ----- receiverTeamInformation
                                                fieldWithPath(
                                                                "result.content[].receiverTeamInformation")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("수신자 팀 정보"),
                                                fieldWithPath(
                                                                "result.content[].receiverTeamInformation.teamCode")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 팀 아이디 (팀 코드)"),
                                                fieldWithPath(
                                                                "result.content[].receiverTeamInformation.teamName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 팀 이름"),
                                                fieldWithPath(
                                                                "result.content[].receiverTeamInformation.teamLogoImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 팀 로고 이미지 경로"),
                                                fieldWithPath(
                                                                "result.content[].receiverTeamInformation.teamScaleItem")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("수신자 팀 규모 정보"),
                                                fieldWithPath(
                                                                "result.content[].receiverTeamInformation.teamScaleItem.teamScaleName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("수신자 팀 규모명"),

                                                // ----- receiverAnnouncementInformation 추가
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("수신자 공고 정보"),
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation.teamMemberAnnouncementId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("공고 아이디"),
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation.teamName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 올림 팀의 이름"),
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation.announcementTitle")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 제목"),
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation.teamLogoImagePath")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 올림 팀의 로고 이미지 경로"),
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation.announcementPositionItem")
                                                        .type(JsonFieldType.OBJECT)
                                                        .description("공고 포지션 정보"),
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation.announcementPositionItem.majorPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 포지션 대분류"),
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation.announcementPositionItem.subPosition")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 포지션 소분류"),
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation.announcementSkillNames")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("공고 요구 스킬 목록"),
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation.announcementSkillNames[].announcementSkillName")
                                                        .type(JsonFieldType.STRING)
                                                        .description("공고 요구 스킬 이름"),
    ...
    void getRequestedMatchingMenu() throws Exception {
        // given
        RequestedMatchingMenu requestedMatchingMenu1 =
                RequestedMatchingMenu.builder()
                        .matchingId(1L)
                        .senderType(SenderType.PROFILE)
                        .receiverType(ReceiverType.PROFILE)
                        .isChatRoomCreated(true)
        ...
        RequestedMatchingMenu requestedMatchingMenu2 =
                RequestedMatchingMenu.builder()
                        .matchingId(2L)
                        .senderType(SenderType.PROFILE)
                        .receiverType(ReceiverType.PROFILE)
        ...
        List<RequestedMatchingMenu> requestedMatchingMenus =
                Arrays.asList(requestedMatchingMenu1, requestedMatchingMenu2);
        Page<RequestedMatchingMenu> matchingReceivedMenus =
                new PageImpl<>(
                        requestedMatchingMenus,
                        PageRequest.of(0, 20),
                        requestedMatchingMenus.size());

        // when
        when(sendMatchingService.getRequestedMatchingMenuResponse(
                        anyLong(), any(), any(Pageable.class)))
                .thenReturn(matchingReceivedMenus);

        final ResultActions resultActions =
                performGetMatchingRequestedMenu(SenderType.PROFILE, 0, 20);
                        ...
                        .andDo(
                                restDocs.document(
                                        ...
                                        responseFields(
                                                ...
                                                // receiverAnnouncementInformation (수정된 부분:
                                                // content[] 내부)
                                                fieldWithPath(
                                                                "result.content[].receiverAnnouncementInformation")
                                                        .type(JsonFieldType.OBJECT)
    ...
    void updateReceivedMatchingRequestedStateRead() throws Exception {
        ...
        final UpdateReceivedMatchingReadRequest request =
                UpdateReceivedMatchingReadRequest.builder()
                        .matchingIds(Arrays.asList(1L, 2L))
                        .build();

        final UpdateReceivedMatchingCompletedStateReadItems
                updateReceivedMatchingCompletedStateReadItems =
                        UpdateReceivedMatchingCompletedStateReadItems.builder()
                                .updateReceivedMatchingCompletedStateReadItems(
                                        Arrays.asList(
                                                UpdateReceivedMatchingCompletedStateReadItem
                                                        .builder()
                                                        .matchingId(1L)
                                                        .receiverReadStatus(
                                                                ReceiverReadStatus
                                                                        .READ_REQUESTED_MATCHING)
                                                        .build(),
                                                UpdateReceivedMatchingCompletedStateReadItem
                                                        .builder()
                                                        .matchingId(2L)
                                                        .receiverReadStatus(
                                                                ReceiverReadStatus
                                                                        .READ_COMPLETED_MATCHING)
                                                        .build()))
                                .build();

        // when
        when(receiveMatchingService.updateReceivedMatchingStateToRead(any()))
                .thenReturn(updateReceivedMatchingCompletedStateReadItems);
                                ...
                                restDocs.document(
                                        requestFields(
                                                fieldWithPath("matchingIds")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description(
                                                                "매칭 ID 목록. 읽음 처리할 매칭 (MatchingStatusType -> REQUESTED && ReceiverReadStatus -> UNREAD_REQUESTED_MATCHING)인 항목들")),
                                        responseFields(
                                                fieldWithPath("isSuccess")
                                                        .type(JsonFieldType.BOOLEAN)
                                                        .description("요청 성공 여부"),
                                                ...
                                                fieldWithPath("result")
                                                        ...
                                                        .description("결과 데이터"),
                                                fieldWithPath(
                                                                "result.updateReceivedMatchingCompletedStateReadItems")
                                                        .type(JsonFieldType.ARRAY)
                                                        .description("업데이트된 매칭 항목 목록"),
                                                fieldWithPath(
                                                                "result.updateReceivedMatchingCompletedStateReadItems[].matchingId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("업데이트된 매칭 ID"),
                                                fieldWithPath(
                                                                "result.updateReceivedMatchingCompletedStateReadItems[].receiverReadStatus")
                                                        .type(JsonFieldType.STRING)
    ...
    void deleteReceivedMatchingItems() throws Exception {
        ...
        final DeleteReceivedMatchingRequest request =
                DeleteReceivedMatchingRequest.builder().matchingIds(Arrays.asList(1L, 2L)).build();

        final DeleteReceivedMatchingItems deleteReceivedMatchingItems =
                DeleteReceivedMatchingItems.builder()
        ...
        // when
        when(receiveMatchingService.deleteReceivedMatchingItems(any()))
                .thenReturn(deleteReceivedMatchingItems);
                        ...
                        .andDo(
                                restDocs.document(
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath(
                                                                "result.deleteReceivedMatchingItems[].matchingId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("삭제된 매칭 ID"),
                                                fieldWithPath(
                                                                "result.deleteReceivedMatchingItems[].receiverDeleteStatus")
                                                        .type(JsonFieldType.STRING)
    ...
    void deleteRequestedMatchingItems() throws Exception {
        ...
        final DeleteRequestedMatchingRequest request =
                DeleteRequestedMatchingRequest.builder().matchingIds(Arrays.asList(1L, 2L)).build();

        final DeleteRequestedMatchingItems deleteRequestedMatchingItems =
                DeleteRequestedMatchingItems.builder()
                        ...
                        .build();
        // when
        when(sendMatchingService.deleteRequestedMatchingItems(any()))
                .thenReturn(deleteRequestedMatchingItems);
                                ...
                                restDocs.document(
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath("result.deleteRequestedMatchingItems")
                                                        ...
                                                        .description("삭제된 매칭 항목 목록"),
                                                fieldWithPath(
                                                                "result.deleteRequestedMatchingItems[].matchingId")
                                                        .type(JsonFieldType.NUMBER)
                                                        .description("삭제된 매칭 ID"),
                                                fieldWithPath(
                                                                "result.deleteRequestedMatchingItems[].senderDeleteStatus")
                                                        .type(JsonFieldType.STRING)
                                                        .description("삭제된 매칭의 삭제 상태"))))
                        .andReturn();
    }
