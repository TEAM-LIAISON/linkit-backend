...
public class LogSearchControllerTest extends ControllerTest {
    ...
    void getHomeLogInformMenus() throws Exception {
        // given
        final LogResponseDTO.LogInformMenus logInformMenus = LogInformMenus.builder()
                .logInformMenus(
                        Arrays.asList(
                        ...
                        restDocs.document(
                                responseFields(
                                        ...
                                        fieldWithPath("result.logInformMenus[].domainType")
                                                .type(JsonFieldType.STRING)
                                                .description("로그의 도메인 타입 (PROFILE 또는 TEAM)"),
                                        ...
                                        fieldWithPath("result.logInformMenus[].logInformDetails")
                                                .type(JsonFieldType.OBJECT)
                                        ...
                                        fieldWithPath("result.logInformMenus[].logInformDetails.memberName")
                                                ...
                                                .optional(),
                                        fieldWithPath("result.logInformMenus[].logInformDetails.profileImagePath")
                                                .type(JsonFieldType.STRING)
                                        ...
                                        fieldWithPath("result.logInformMenus[].logInformDetails.teamName")
                                                ...
                                                .optional(),
                                        fieldWithPath("result.logInformMenus[].logInformDetails.teamLogoImagePath")
                                                .type(JsonFieldType.STRING)
