...
//    }
//
/// /    @Test /    @DisplayName("채팅방 구독 테스트") /    void subscribeChat() throws Exception { /
// // given /        Long chatRoomId = 1L; /        BlockingQueue<ChatMessageResponse> messages =
// new
/// LinkedBlockingQueue<>(); /        StompSession session = connectSession(); / /        // when /
//       StompSession.Subscription subscription = session.subscribe( /
// WEBSOCKET_TOPIC
/// + chatRoomId, /                new StompFrameHandler() { /                    @Override /
//             public Type getPayloadType(StompHeaders headers) { /                        return
/// ChatMessageResponse.class; /                    } / /                    @Override /
//        public void handleFrame(StompHeaders headers, Object payload) { /
/// messages.add((ChatMessageResponse) payload); /                    } /                }); / /
//    // then /        assertNotNull(subscription); /        assertTrue(session.isConnected()); /
/// }
//
////    @Test
